  ...
  return (
    ...
    >
      ...
      <div className="text1 w-full h-[60vh] relative  mt-[120vh] ">
        ...
        <h1 className='hel text-[2.85vw] mt-20 font-regular uppercase text-white tracking-tighter'>a new graphic model from j.d. paulsen, coming soon</h1>
        <h1 className='hel font-black uppercase text-[9.5vw] text-[#EACD58] -mt-10'>violet's code</h1>
        <h1 className=' hel font-regular -mt-6 text-[2.85vw] text-white uppercase text-right ml-[30vw]'>the past will be our end</h1>
        </div>
        <div className="chopper w-[40%] absolute -bottom-12 ml-3  h-[45vh] ">
          <img src={ image2} className='w-full h-full scale-110  object-contain' alt="" />
          </div>
      </div>

      <div className="text2 w-full h-[42vh]  mt-36 gap-6 flex items-center flex-col ">
        <h1 className='hel w-[78%] text-5xl font-regular text-center text-[#EACD58]'>A brilliant young scientist develops a radical plan to save Earth from an ecological disaster but falls for the woman on a mission to stop him.</h1>
